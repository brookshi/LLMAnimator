...
namespace LLM.Animation
{
    public class ZoomInRightAnimation : AnimationBase
    {
        ...
        public override void PlayOn(UIElement target, Action continueWith)
        {
            ...
            target.Opacity = 0;
            transform.TranslateX = AnimUtils.GetParentSize(target).Width - AnimUtils.GetPointInParent(target).X;
            ...
            var transformXAnim = AnimUtils.CreateAnimationWithValues(Duration.TotalMilliseconds, -30, 0);
